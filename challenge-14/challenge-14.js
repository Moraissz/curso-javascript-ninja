(function(){
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce(function(acumulate,value){
                  return (acumulate + 1) * value;
    },0)
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduceRight(function(acumulate,value){
                    return(acumulate+1) * value;
    },0)
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = name.reduceRight(function(acumulate,value){
    ...
    */
    ...
    numberObjects.lastIndexOf({number : 2},2) > -1 ?  console.log('Existe um objeto { number: 2 } em numberObjects!') : console.log('Não existe um objeto { number: 2 } em numberObjects :(');
